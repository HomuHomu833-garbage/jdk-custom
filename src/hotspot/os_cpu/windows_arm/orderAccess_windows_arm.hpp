...
#ifndef OS_CPU_WINDOWS_ARM_ORDERACCESS_WINDOWS_ARM_HPP
#define OS_CPU_WINDOWS_ARM_ORDERACCESS_WINDOWS_ARM_HPP
...
#endif // OS_CPU_WINDOWS_ARM_ORDERACCESS_WINDOWS_ARM_HPP
