...
#ifndef OS_CPU_WINDOWS_ARM_JAVATHREAD_WINDOWS_ARM_HPP
#define OS_CPU_WINDOWS_ARM_JAVATHREAD_WINDOWS_ARM_HPP
...
#endif // OS_CPU_WINDOWS_ARM_JAVATHREAD_WINDOWS_ARM_HPP
